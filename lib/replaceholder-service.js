...
const escapeRegularExpressionSpecialCharacter = require("./escape-regular-expression-special-character.js");
/**
 * @description JSON query and transformation.
 */
class Replaceholder {
	#keyRegularExpressionBlock
	#keyRegularExpressionInline
	#keyRegularExpressionPlain
	#list;
	#prefix;
	#replaceUndefined;
	#suffix;
	...
	#replaceInternal(item) {
		if (Array.isArray(item) === true) {
			return item.map((element) => {
				return this.#replaceInternal(element);
			});
		};
