...
function divide(item, piece, option = {}) {
	...
	if (advancedDetermine.isNumber(piece, { finite: true, integer: true, positive: true, safe: true }) !== true) {
		throw new TypeError(`Argument \`piece\` must be type of number (finite, integer, positive, and safe)!`);
	};
	if (piece < 1) {
