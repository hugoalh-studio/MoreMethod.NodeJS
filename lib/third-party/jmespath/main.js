...
// ISSUE: Key "Not", "Star", "Flatten", "Expref", "Dot", "Pipe", "Or", "And", and "Filter" is called but missing at here and not assigned anywhere; Useless reference or conventation issue???
...
class Runtime {
	...
	_functionSortBy(resolvedArgs) {
		...
		let requiredType = getTypeName(interpreter.visit(exprefNode, sortedArray[0]));
